...
### Added
- Photo Triangles gained a "Polygon Margin" slider (0–3 mm in 0.1 mm steps) so each triangle insets before hatching, creating gutters like Simple Perfect Rectangle.
